...
# 链接到 bin 目录
sudo ln -sf ${current_dir}/bin/cpc /usr/local/bin/cpc || exit 4
# 链接到 man 目录
sudo mkdir -p /usr/local/share/man/man1 && ln -f ${current_dir}/man/cpc.1 /usr/local/share/man/man1/cpc.1 || exit 5
